...
-- When to know, what 
-- Whenever We want to perform filtering based on the the aggregrate operation, that falls under
-- the HAVING Condition. 
-- But whenever we want to performs filtering Like this ones.. scalar types.. num_phones more than 10 among 
-- all 5g enabled phones. 
